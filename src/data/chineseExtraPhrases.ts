...
const chineseExtraPhraseSeeds: ChineseExtraPhraseSeed[] = [
  ...
  { id: 'zh-extra-002', text: '早安。', pinyin: 'zǎo ān', japanese: 'おはよう。', kana: 'ザオ アン', scene: '朝のあいさつ', category: 'greeting', spotId: 'home' },
  ...
  { id: 'zh-extra-020', text: '请多关照。', pinyin: 'qǐng duō guān zhào', japanese: 'よろしくお願いします。', kana: 'チン ドゥオ グアン ジャオ', scene: '自己紹介の締め', category: 'self_intro', spotId: 'home' },
  ...
  { id: 'zh-extra-023', text: '太谢谢了。', pinyin: 'tài xiè xie le', japanese: 'とても助かりました。', kana: 'タイ シエ シエ ラ', scene: '強く感謝する', category: 'thanks_apology', spotId: 'home' },
  ...
  { id: 'zh-extra-028', text: '请原谅我。', pinyin: 'qǐng yuán liàng wǒ', japanese: '許してください。', kana: 'チン ユエン リャン ウォ', scene: '丁寧に謝る', category: 'thanks_apology', spotId: 'home' },
  ...
  { id: 'zh-extra-030', text: '辛苦你了。', pinyin: 'xīn kǔ nǐ le', japanese: 'お疲れさまです。', kana: 'シン クー ニー ラ', scene: '相手をねぎらう', category: 'thanks_apology', spotId: 'office' },
  ...
  { id: 'zh-extra-071', text: '请问，地铁站在哪里？', pinyin: 'qǐng wèn, dì tiě zhàn zài nǎ lǐ', japanese: 'すみません、地下鉄駅はどこですか？', kana: 'チン ウェン ディー ティエ ジャン ザイ ナー リー', scene: '地下鉄駅を聞く', category: 'direction', spotId: 'station' },
  ...
  { id: 'zh-extra-087', text: '请打扫房间。', pinyin: 'qǐng dǎ sǎo fáng jiān', japanese: '部屋を掃除してください。', kana: 'チン ダー サオ ファン ジエン', scene: '清掃をお願いする', category: 'hotel', spotId: 'hotel' },
  ...
  { id: 'zh-extra-094', text: '我会发邮件。', pinyin: 'wǒ huì fā yóu jiàn', japanese: 'メールを送ります。', kana: 'ウォ ホイ ファー ヨウ ジエン', scene: '連絡方法を伝える', category: 'business_basic', spotId: 'office' },
  ...
  { id: 'zh-extra-100', text: '今天辛苦了。', pinyin: 'jīn tiān xīn kǔ le', japanese: '今日もお疲れさまでした。', kana: 'ジン ティエン シン クー ラ', scene: '仕事終わりのあいさつ', category: 'business_basic', spotId: 'office' },
];
